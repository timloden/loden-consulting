    ...
    <div class="row sliced-upper">
        ...
        <div class="col-sm-12 sliced-login">
            ...
            <h3 class="text-center"><?php _e( 'Login', 'sliced-invoices-client-area' ) ?></h3>
                ...
                <div class="form-group">
                    <input type="password" name="pwd" id="user_pass" class="form-control required" placeholder="<?php _e( 'Password', 'sliced-invoices-client-area' ) ?>">
                </div>
                ...
                <div class="checkbox">
                    <label>
                        <input type="checkbox" value="forever" id="rememberme" name="rememberme" checked="checked"> <?php _e( 'Remember Me', 'sliced-invoices-client-area' ) ?>
                    </label>
                </div>
