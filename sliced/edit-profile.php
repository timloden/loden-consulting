            ...
            <form method="post" id="update-user" action="<?php the_permalink(); ?>">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-6">
                            <label
                                for="business"><?php _e('Business/Client Name', 'sliced-invoices-client-area' ); ?></label>
                            <input class="form-control" name="business" type="text" id="business"
                                value="<?php echo $current_user->_sliced_client_business; ?>" />
                            <p class="help-block">
                                <?php _e('The name of your business or your trading name.', 'sliced-invoices-client-area' ); ?>
                            </p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <textarea name="address" id="address" rows="3" cols="50"
                                class="form-control"><?php echo $current_user->_sliced_client_address; ?></textarea>
                            <p class="help-block">
                                <?php _e('Format the Address any way you like. HTML is allowed.', 'sliced-invoices-client-area' ); ?>
                            </p>
                        </div>

                        <div class="col-sm-6">
                            <label for="extra_info"><?php _e('Extra Info', 'sliced-invoices-client-area' ); ?></label>
                            <textarea name="extra_info" id="extra_info" rows="3" cols="50"
                                class="form-control"><?php echo $current_user->_sliced_client_extra_info; ?></textarea>
                            <p class="help-block">
                                <?php _e('Phone number, business number, VAT details etc. HTML is allowed.', 'sliced-invoices-client-area' ); ?>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input name="updateuser" type="submit" id="updateuser" class="submit btn btn-success"
                        value="<?php _e('Update Details', 'sliced-invoices-client-area'); ?>" />
